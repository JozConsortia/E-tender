...
function requirementMatchesDocument(requirement, documentName) {
    ...
    if (!requirementWords.length || !docWords.length)
        return false;
...
export function validateSubmittedDocuments(documents, tender) {
