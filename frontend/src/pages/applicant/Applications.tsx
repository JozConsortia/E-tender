...
export default function Applications() {
  ...
  return <><PageHeader title="My applications" description="Private view of your tender submissions and current status." />
    {mine.length ? <div className="card table-card"><div className="table-wrap"><table><thead><tr><th>Reference</th><th>Tender</th><th>Documents</th><th>Status</th><th></th></tr></thead><tbody>{mine.map((a) => <tr key={a.id}>
